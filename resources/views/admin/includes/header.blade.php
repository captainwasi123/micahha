                            ...
                            <li>
                                <div class="dw-user-box">
                                    ...
                                    <div class="u-text">
                                        ...
                                        <p class="text-muted">{{Auth::guard('admin')->user()->email}}</p><a href="{{route('admin.logout')}}" class="btn btn-rounded btn-danger btn-sm"><i class="fa fa-power-off"></i> Logout</a></div>
                                </div>
                            </li>
                        </ul>
                    </div>
