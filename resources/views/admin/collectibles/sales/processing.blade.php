                            ...
                            @foreach($data as $key => $val)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button type="button" class="btn btn-sm btn-info deliverSale" data-toggle="tooltip" data-original-title="Delivered" data-id="{{base64_encode($val->id)}}"><i class="mdi mdi-clipboard-check" aria-hidden="true"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                            @if(count($data) == 0)
