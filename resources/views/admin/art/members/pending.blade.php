...
@section('title', 'Pending | Members | Art & Portrait Customization')
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach($data as $val)
                                <tr>
                                    ...
                                    <td> 
                                    	<a href="#" data-toggle="tooltip" data-original-title="Approve" class="btn btn-success btn-sm memberApproveArt" data-id="{{base64_encode($val->id)}}"> 
                                    		<i class="fa fa-check"></i> 
                                    	</a>
                                    	&nbsp;&nbsp;
                                        <a href="#" data-toggle="tooltip" data-original-title="Reject" class="btn btn-danger btn-sm memberRejectArt" data-id="{{base64_encode($val->id)}}">
