...
@section('title', 'New Requests | Withdraw | Art')
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach($data as $val) 
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" class="btn btn-sm btn-primary artWithdrawPaid" data-toggle="tooltip" data-original-title="Paid" data-id="{{base64_encode($val->id)}}">
                                            <span class="fa fa-thumbs-up"></span>
                                        </a>

                                        <a href="javascript:void(0)" class="btn btn-sm btn-warning artWithdrawHold" data-toggle="tooltip" data-original-title="Hold" data-id="{{base64_encode($val->id)}}">
