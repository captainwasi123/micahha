...
@section('title', 'Published | Products | Art')
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach($data as $val) 
                                <tr>
                                    ...
                                    <td> 
                                        <a href="javascript:void(0)" data-id="{{base64_encode($val->id)}}" class="productRejectArt" data-toggle="tooltip" data-original-title="Reject">
