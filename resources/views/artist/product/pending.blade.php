                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($product_data as $key => $val)    
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('artist.product.edit',base64_encode($val->id))}}" data-toggle="tooltip" data-original-title="delete" class="btn btn-info btn-sm" >
                                                        <i class="fas fa-edit" style="color:#fff"></i>
                                                    </a>
                                                    <a onclick="return confirm_click();" href="{{route('artist.product.delete',base64_encode($val->id))}}" data-toggle="tooltip" data-original-title="delete" class="btn btn-danger btn-sm">
