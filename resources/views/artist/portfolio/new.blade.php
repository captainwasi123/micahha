...
@section('title', 'Add Portrait Portfolio | Artist')
@section('content')
            ...
            <div class="card">
                <div class="box_header m-0 mb-3">
                    <div class="main-title">
                        <h3 class="m-0">Add Portrait Portfolio | Artist</h3>
                ...
                <div class="card-body">
                	<div class="form-row">
                        ...
                        <div class="form-group col-md-2 col-xs-8 mt-3">
                            ...
                            <div class="form-group mb-0">
                                <input type="number" class="form-control" name="no_of_subject" required>
                            </div>
                        </div>
                        <div class="form-group col-md-2 col-xs-8 mt-3">
