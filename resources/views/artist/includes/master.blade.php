...
<head>
    ...
    @include('artist.includes.style')
    @yield('addStyle')

</head>
<body class="crm_body_bg">

            @include('artist.includes.sidebar')
             @include('artist.includes.header')
            ...
            <!-- footer -->
            <!-- ============================================================== -->
                @include('artist.includes.footer')
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
        @include('artist.includes.script')
        @yield('addScript')
